...
export class FreeAgencyResponse {
    ...
    constructor(source: any = {}) {
        if ('string' === typeof source) source = JSON.parse(source);
        this.FreeAgents = this.convertValues(source["FreeAgents"], ProfessionalPlayer);
        this.WaiverPlayers = this.convertValues(source["WaiverPlayers"], ProfessionalPlayer);
        this.PracticeSquad = this.convertValues(source["PracticeSquad"], ProfessionalPlayer);
