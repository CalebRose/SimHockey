...
export class DraftPick {
    ...
    constructor(source: any = {}) {
        ...
        this.SelectedPlayerType = source["SelectedPlayerType"];
...
export class DraftablePlayer {
    ...
    GoalieReboundControlGrade: string;
    ...
    constructor(source: any = {}) {
        ...
        this.OneTimerGrade = source["OneTimerGrade"];
        ...
        this.GoalieReboundControlGrade = source["GoalieReboundControlGrade"];
        ...
        this.DraftablePlayerType = source["DraftablePlayerType"];
    }
...
export class ProDraftPageResponse {
    WarRoomMap: {[key: uint]: ProWarRoom};
    DraftablePlayers: DraftablePlayer[];
    ScoutingProfiles: ScoutingProfile[];
    DraftPicks: {[key: uint]: DraftPick[]};

    constructor(source: any = {}) {
        if ('string' === typeof source) source = JSON.parse(source);
        this.WarRoomMap = this.convertValues(source["WarRoomMap"], ProWarRoom, true);
        this.DraftablePlayers = this.convertValues(source["DraftablePlayers"], DraftablePlayer);
        this.ScoutingProfiles = this.convertValues(source["ScoutingProfiles"], ScoutingProfile);
...
export class CollegePlayer {
    ...
    constructor(source: any = {}) {
        ...
        this.DraftPickID = source["DraftPickID"];
        this.DraftedPick = source["DraftedPick"];
        this.DraftedYearID = source["DraftedYearID"];
...
export class RecruitingTeamProfile {
    ...
    constructor(source: any = {}) {
        ...
        this.Y4Rank = source["Y4Rank"];
        this.Y5Rank = source["Y5Rank"];
...
export class CollegeStandings {
    ...
    constructor(source: any = {}) {
        ...
        this.IsConferenceTournamentChampion = source["IsConferenceTournamentChampion"];
...
export class BootstrapData {
    ...
    CollegeLineupsMap: {[key: uint]: CollegeLineup[]};
    CollegeTeamLineups: CollegeLineup[];
    CollegeTeamShootoutLineup: CollegeShootoutLineup;
    CollegeShootoutLineupsMap: {[key: uint]: CollegeShootoutLineup};
    ...
    ProLineupsMap: {[key: uint]: ProfessionalLineup[]};
    ProTeamLineups: ProfessionalLineup[];
    ProShootoutLineupsMap: {[key: uint]: ProfessionalShootoutLineup};
    ...
    constructor(source: any = {}) {
        ...
        this.CollegeShootoutLineupsMap = this.convertValues(source["CollegeShootoutLineupsMap"], CollegeShootoutLineup, true);
        ...
        this.HockeyInvitationals = this.convertValues(source["HockeyInvitationals"], HockeyInvitational);
        this.HockeyInvitationalRequests = this.convertValues(source["HockeyInvitationalRequests"], HockeyInvitationalRequest);
        this.CollegeGameRequests = this.convertValues(source["CollegeGameRequests"], CHLGameRequest);
        ...
        this.ProShootoutLineupsMap = this.convertValues(source["ProShootoutLineupsMap"], ProfessionalShootoutLineup, true);
...
export class Timestamp {
    ...
    CHLAttributesUpdated: boolean;
    SeasonMigrationDone: boolean;
    ...
    constructor(source: any = {}) {
        ...
        this.CHLAttributesUpdated = source["CHLAttributesUpdated"];
        this.SeasonMigrationDone = source["SeasonMigrationDone"];
