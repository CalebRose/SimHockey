...
func handleRequests() http.Handler {
	...
	// apiRouter.HandleFunc("/admin/postseason/draftees/table/fix/", controllers.FixDraftablePlayersTable).Methods("GET")
	...
	// apiRouter.HandleFunc("/admin/preseason/poll/", controllers.GeneratePreseasonPoll).Methods("GET")
	// Bootstrap
	...
	apiRouter.HandleFunc("/bootstrap/lineups/{collegeID}/{proID}", controllers.BootstrapLineUpsData).Methods("GET")
	apiRouter.HandleFunc("/bootstrap/schedule/{collegeID}/{username}", controllers.BootstrapScheduleData).Methods("GET")
	...
	apiRouter.HandleFunc("/export/draftable/players", controllers.ExportDraftablePlayersToCSV).Methods("GET")
	...
	// Free Agency
	apiRouter.HandleFunc("/phl/freeagency/toggle", controllers.ToggleFreeAgency).Methods("GET")
	...
	apiRouter.HandleFunc("/chl/roster/injury/reserve/{playerID}", controllers.PlaceCHLPlayerOnInjuryReserve).Methods("GET")
	...
	apiRouter.HandleFunc("/phl/roster/injury/reserve/{playerID}", controllers.PlacePHLPlayerOnInjuryReserve).Methods("GET")
...
func handleCron() *cron.Cron {
	...
	if runJobs != "false" {
		...
		c.AddFunc("0 3 * * 1", controllers.RunPostSeasonMigrationViaCron)
